...
import { Zap, Magnet, Rocket, Shield, ArrowLeft, Crosshair, Anchor, EyeOff, Star, Activity, ShoppingCart } from 'lucide-react';
                    ...
                    {activeTab === 'upgrades' ? (
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {UPGRADES.map((item) => {
                                ...
                                return (
                                    <div key={item.id} className="group relative bg-black/40 border border-white/10 rounded-xl p-5 hover:border-neon-blue/50 transition-all hover:shadow-[0_0_20px_rgba(0,243,255,0.15)] hover:-translate-y-1">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {SHIPS.map((item) => {
                                ...
                                return (
                                    <div key={item.id} className={`group relative bg-black/40 border rounded-xl p-5 transition-all hover:-translate-y-1 ${isEquipped
